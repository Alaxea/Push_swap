...
void			sort_5_num(long *stack_a, long *stack_b,
					int *num_in_a, int *num_in_b);
void			sort_other(long *stack_a, long *stack_b,
					int *num_in_a, int *num_in_b);
//UTILS
...
void			operations(long *stack_a, long *stack_b,
					int *num_in_a, int *num_in_b);
...
int				check_separated_input(long *stack_a,
					int *num_in_a, char **argv);
